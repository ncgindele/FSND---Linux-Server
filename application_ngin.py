...
CLIENT_ID = json.loads(open('google_client_secrets_ngin.json', 'r').read())[
    'web']['client_id']
...
def gconnect():
    ...
    try:
        ...
        oauth_flow = flow_from_clientsecrets(
            'google_client_secrets_ngin.json', scope='')
...
def fbconnect():
    ...
    app_id = json.loads(open('fb_client_secrets_ngin.json', 'r').read())[
        'web']['app_id']
    app_secret = json.loads(open('fb_client_secrets_ngin.json', 'r').read())[
        'web']['app_secret']

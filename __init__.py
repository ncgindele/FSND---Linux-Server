...
CLIENT_ID = json.loads(open('/var/www/Catalog/Catalog/google_client_secrets_ngin.json', 'r').read())[
    'web']['client_id']
...
def showLogin():
    ...
    return render_template('login_ngin.html', STATE=state)
...
def gconnect():
    ...
    try:
        ...
        oauth_flow = flow_from_clientsecrets(
            '/var/www/Catalog/Catalog/google_client_secrets_ngin.json', scope='')
...
def fbconnect():
    ...
    app_id = json.loads(
        open('/var/www/Catalog/Catalog/fb_client_secrets_ngin.json', 'r').read())['web']['app_id']
    app_secret = json.loads(
        open('/var/www/Catalog/Catalog/fb_client_secrets_ngin.json', 'r').read())['web']['app_secret']
